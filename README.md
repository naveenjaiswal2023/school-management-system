...
Future: Cache	Redis	N/A
Future: Queue	RabbitMQ/Azure Service Bus	N/A
...
Unit of Work: Transaction consistency across repositories
Query Objects: Complex queries encapsulated in query classes
Specification Pattern: Reusable query criteria (planned)
Security Architecture
Authentication
...
Role Level: User must have assigned role
Menu Level: User must have permission for specific menu
Action Level: Read/Write/Delete permissions per menu
